  ...
  deer_tracks_found: {
    ...
    actions: [
      makeEncounterSkillAction(
        "Try to track the deer",
        { knowledge: true, skill: ["hunter"], dc: 6 },
        {
          failure: makeOutcome("You lost the tracks and spent some time finding your way back."),
          success: {
            nextFrameId: "combat",
    ...
    actions: [
      makeEncounterSkillAction(
        ...
        { knowledge: true, dc: 5, skill: [] },
        {
          ...
          success: makeOutcome("These tubers are good and seems nutritious, I should gather some", {
            resourceYield: { tuber: 5 },
            discovery: "find_tubers",
          }),
        },
        { cost: { minutes: 60, energy: 0 } },
      ),
    ],
  },
  wolf_encounter: {
    ...
    actions: [
      makeEncounterSkillAction(
        "Stand your ground",
        { knowledge: true, skill: ["stealth", "hunter"], dc: 9 },
        {
          failure: {
            nextFrameId: "combat",
            spawnCreatures: [
        ...
        { cost: { minutes: 10, energy: 0 } },
      ),
      makeEncounterSkillAction(
        "Try to catch it unaware",
        { knowledge: true, skill: ["stealth"], dc: 7 },
        {
          failure: {
            nextFrameId: "combat",
            spawnCreatures: [
